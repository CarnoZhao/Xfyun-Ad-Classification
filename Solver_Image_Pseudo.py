...
class Model(pl.LightningModule):
    def __init__(self, **args):
        ...
        # self.model.load_state_dict({k[6:]: v for k, v in torch.load(self.load_from)["state_dict"].items()})
...
args = dict(
    ...
    # load_from = "./logs/image/b4ns/sorted_all/checkpoints/epoch=28_valid_metric=0.990.ckpt",
    drop_rate = 0.1,
